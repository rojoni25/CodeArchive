    ...
    if (isset($name)) {
        ...
        if (!empty($name) && $fileextension==$PrefLang){
            if (move_uploaded_file($tmp_name, $path.$name)) {
                ...
                $stmt = $con->prepare("INSERT INTO ProblemTable (ProblemId,Email,Title,Description,Language,Code,File,Date) VALUES (?, ?, ?, ?, ?, ?, ?,?)");
        ...
        else{echo 'Invalid File. Please upload '.$PrefLang.' file.';}
    }
